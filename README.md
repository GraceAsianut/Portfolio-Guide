...
| 💵 [Business Expenses](https://github.com/GraceAsianut/Excel/blob/main/Business%20Expenses.xlsx) | Mar 2023 | Power Query, Pivot Tables | Designed, created, and implemented pivot tables to categorize the business expenses. |
